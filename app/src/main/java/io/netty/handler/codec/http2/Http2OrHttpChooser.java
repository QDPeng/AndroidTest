...
public abstract class Http2OrHttpChooser extends ByteToMessageDecoder {
    ...
    /**
     * Return the {@link SelectedProtocol} for the {@link SSLEngine}. If its not known
    ...
    /**
     * Add all {@link ChannelHandler}'s that are needed for HTTP_2.
     */
    ...
    /**
     * Create the {@link ChannelHandler} that is responsible for handling the http
